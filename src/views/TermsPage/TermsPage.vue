<template>
  <div class="terms">
    ...
    <strong class="d-inline-block mb-2">Welcome to iMorse!</strong>
    <p>
      These terms and conditions outline the rules and regulations for the use of iMorse SA's Website, located at
      iMorse.com.
      By accessing this website we assume you accept these terms and conditions. Do not continue to use iMorse if you do
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By accessing iMorse, you agreed to use cookies in agreement with the iMorse SA's
      Privacy Policy.
    </p>
    <p>
    ...
    <h2>License</h2>
    <pre>
      Unless otherwise stated, iMorse SA and/or its licensors own the intellectual property rights for all material on
      imorse. All intellectual property rights are reserved. You may access this from imorse for your own personal use
      ...
      of the website. iMorse SA does not filter, edit, publish or review Comments prior to their presence on the website.
      Comments do not reflect the views and opinions of iMorse SA,its agents and/or affiliates. Comments reflect the views
      and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, iMorse SA
      ...
      iMorse SA reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      activity.
      You hereby grant iMorse SA a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
      ...
      with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of iMorse SA; and (d)
      ...
      must inform us by sending an e-mail to iMorse SA. Please include your name, your organization name, contact
      ...
      No use of iMorse SA's logo or other artwork will be allowed for linking absent a trademark license agreement.
    </pre>
